    ...
    public class MemberDAO
    {
        ...
        public void AddMember(Member member)
        {
            ...
            try
            {
                ...
                if (_mem1 == null && _mem2 == null && member.MemberId != 0)
                {
                    using var context = new FStoreDBContext();
        ...
        public Member Login(string email, string password)
        {
            ...
            try
            {
                Member admin = LoginAsAdmin(email, password);
                if (admin == null)
                {
                    member = LoginAsMember(email, password);
                } else
                {
                    member = admin;
                }
        ...
        Member LoginAsMember(string email, string password)
        {
            Member member = null;
            try
            {
        ...
        Member LoginAsAdmin(string email, string password)
        {
            Member admin = null;
