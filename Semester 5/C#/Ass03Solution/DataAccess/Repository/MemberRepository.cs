...
namespace DataAccess.Repository
{
    public class MemberRepository : IMemberRepository
    {
        ...
        public Member LoginMember(string email, string password) => MemberDAO.Instance.LoginAsMember(email, password);
        public Member LoginAdmin(string email, string password) => MemberDAO.Instance.LoginAsAdmin(email, password);
